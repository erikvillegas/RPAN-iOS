...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/HTMLSpecialCharacters/HTMLSpecialCharacters.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/MiniKeychain/MiniKeychain.framework"
